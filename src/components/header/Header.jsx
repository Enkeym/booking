      ...
      <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
        <div className="headerList">
          ...
          <div className="headerListItem">
            ...
            <span>Airport taxsis</span>
          </div>
        </div>
        {type !== "list" &&
          <>
            <h1 className="headerTitle">a lifetime of discounts? It's Genius.</h1>
            <p className="headerDescriptions">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error sint dolor sapiente asperiores! Placeat eum maiores voluptate, ea rem voluptatem ipsa vero iusto, consequuntur, fuga facilis illum libero soluta unde?
            </p>
            <button className="headerBtn">Sign in / Registration</button>
